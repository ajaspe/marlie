 ...
 *	stretchImg: default behavior of image setting on the canvas: set to the canvas whImg: default behavior of image setting on the canvas: set to the canvas width/height or not? false by default
 * }
 */
